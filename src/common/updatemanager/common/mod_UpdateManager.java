 ...
 */
@Mod(modid = "UpdateManager_TheWhiteWolves", name = "Mod Update Manager", version = "v3.3")
public class mod_UpdateManager{
	...
	public void modsLoaded(FMLPostInitializationEvent event) {
		...
		if(client){
			...
			File f = UpdateManager.getDownloadedModsDir();
			f.mkdirs();
		}
	...
	public void load(FMLInitializationEvent event) {
		...
		ModLoader.addLocalization("um.updated.pt_PT", "[Mod Update Manager] Os teus mods est�o atualizados!");
		...
		ModLoader.addLocalization("um.outdated.pt_PT", "[Mod Update Manager] Est�s offline, a verifica��o n�o foi possivel.");
		ModLoader.addLocalization("um.updated.es_ES", "[Mod Update Manager] Tus mods est�n actualizadas!");
		...
		ModLoader.addLocalization("um.offline.es_ES", "[Mod Update Manager] Est�s offline, no pudo comprobar.");
		ModLoader.addLocalization("um.updated.fr_FR", "[Mod Update Manager] Vos mods sont � jours!");
		ModLoader.addLocalization("um.outdated.fr_FR", "[Mod Update Manager] Certains de vos mods ne sont pas � jours, ouvrez votre liste de mods pour les voir.");
		ModLoader.addLocalization("um.offline.fr_FR", "[Mod Update Manager] Vous �tes d�connect�, ne peut pas v�rifier.");
		ModLoader.addLocalization("um.updated.ge_GE", "[Mod Update Manager] �berwachte Mods sind aktuell!");
		ModLoader.addLocalization("um.outdated.ge_GE", "[Mod Update Manager] Veraltete Mods gefunden, f�r Details siehe Liste.");
	...
	public class UpdateHandler extends UpdateManagerMod {
		...
		public String getModURL() {
			return "http://www.minecraftforum.net/topic/1541473-144-mod-update-manager-v33/";
		}
