...
public class GuiChangelog extends GuiScreen {
	...
	protected void actionPerformed(GuiButton button) {
		if (button.id == 0) UpdateManager.openWebpage(linkedMod.getChangelogURL());
		else {
	...
	public void initGui() {
		super.initGui();
		controlList.clear();
		controlList.add(new GuiButton(0, 5, 5, fontRenderer.getStringWidth("View Raw") + 8, 20, "View Raw"));
		controlList.add(new GuiButton(1, width - 13 - fontRenderer.getStringWidth("Back"), 5, fontRenderer.getStringWidth("Back") + 8, 20, "Back"));
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawCenteredString(fontRenderer, "Latest Changelog for " + linkedMod.getModName() + ":", width / 2, 16, 0xFFFFFF);
