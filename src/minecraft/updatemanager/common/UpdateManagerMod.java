...
public abstract class UpdateManagerMod {
	...
	/**
	 * If you have notes enabled (addNotes() isn't null), you can change the headliner
	 * for the notes, this can be used for example, to deliver a newsletter trough the
	 * notes, or something of the like.
	 * 
	...
	/**
	 * Renders an Icon representing this mod into the GUI. Defaults to rendering the ItemStack defined
	 * by getIconStack(), if that is null, does nothing.
	...
	/**
	 * What happens when the special button is clicked? Special buttons are enabled by setting getSpecialButtonName() to something
	 * other than null.
	 */
